...
import { FlagPoland, createReactComponent } from "./src"

describe("React Flag component", () => {
  afterEach(() => {
    cleanup();
  });
  ...
  it('should apply all classNames to the element', () => {
    ...
    const { container } = render(<FlagPoland className={testClass} />);
  ...
  it('should have proper type', () => {
    ...
    expectTypeOf(FlagPoland).toEqualTypeOf(
      createReactComponent('poland', [])
    );
  });

  it("should match snapshot", () => {
    const { container } = render(<FlagPoland size={100} className="test-class" style={{ outline: '1px solid red' }} />);
    expect(container.innerHTML).toMatchInlineSnapshot(`
      <svg xmlns="http://www.w3.org/2000/svg"
           viewbox="0 0 30 24"
           height="100"
           width="125"
           class="tabler-flag tabler-flag-poland test-class"
           style="outline: 1px solid red;"
      >
        <defs>
          <clipPath id="flag-poland-clip">
            <rect width="30"
                  height="24"
                  fill="#fff"
                  rx="4"
        ...
        <g clip-path="url(#flag-poland-clip)">
          <path fill="#fff"
                d="M30 24H0V0h30z"
          >
          </path>
        ...
        <path fill="#fff"
              d="M4 1a3 3 0 0 0-3 3v1a3 3 0 0 1 3-3h22a3 3 0 0 1 3 3v-1a3 3 0 0 0-3-3Z"
              opacity=".1"
        >
        </path>
      </svg>
